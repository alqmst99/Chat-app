...
public class Emogi {
   ...
   private Emogi() {
    ...
    public List<ModelEmoji> getStyle1(){
        ...
        for( int i= 1; i <= 20; i++){
            list.add(new ModelEmoji(i, new ImageIcon(getClass().getResource("/chat/realtime/emogi/icon/"+ i +".png"))));
        }
              return list;
    }
      ...
      public ModelEmoji getEmoji(int id){
         return new ModelEmoji(id, new ImageIcon(getClass().getResource("/chat/realtime/emogi/icon/"+ id +".png")));
      }
}
