...
public class ChatFile extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        progress1 = new chat.realtime.Swing.Progress();
        jPanel1 = new javax.swing.JPanel();
        lbFileName = new javax.swing.JLabel();
        lbFileSize = new javax.swing.JLabel();

        progress1.setProgresstype(chat.realtime.Swing.Progress.ProgressType.DOWN_FILE);
    ...
    private chat.realtime.Swing.Progress progress1;
