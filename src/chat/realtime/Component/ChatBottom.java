...
import chat.realtime.Swing.JIMSendTextPane;
...
public class ChatBottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        btn.setIcon(new ImageIcon(getClass().getResource("/chat/realtime/Icon/send.png")));
...
//create button send Emogi
        ...
        btnMore.setIcon(new ImageIcon(getClass().getResource("/chat/realtime/Icon/more_disable.png")));
        btnMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (panelMore.isVisible()) {
                    ...
                    btnMore.setIcon(new ImageIcon(getClass().getResource("/chat/realtime/Icon/more.png")));
