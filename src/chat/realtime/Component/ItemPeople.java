...
import chat.realtime.Swing.ActiveStatus;
...
public class ItemPeople extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new chat.realtime.Swing.ImageAvatar();
        lbName = new javax.swing.JLabel();
        lbStatus = new javax.swing.JLabel();
        activeStatus = new chat.realtime.Swing.ActiveStatus();

        setBackground(new java.awt.Color(242, 242, 242));
        setPreferredSize(new java.awt.Dimension(200, 50));

        imageAvatar1.setBorderSize(0);
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/chat/realtime/Icon/profile.png"))); // NOI18N
    ...
    private chat.realtime.Swing.ActiveStatus activeStatus;
    private chat.realtime.Swing.ImageAvatar imageAvatar1;
