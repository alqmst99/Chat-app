package chat.realtime.Main;

import chat.realtime.Component.Event.EventImageView;
import chat.realtime.Component.Event.EventMain;
import chat.realtime.Component.Event.PublicEvent;
import chat.realtime.Main.Model.Model_User_Account;
import chat.realtime.Swing.ComponentResizer;
...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/chat/realtime/Icon/icon.png")).getImage());
    ...
    private void initComponents() {
        ...
        loading = new chat.realtime.Form.Loading();
        login = new chat.realtime.Form.Login();
        viewImage = new chat.realtime.Form.ViewImage();
        home = new chat.realtime.Form.Home();
        ...
        btnMinimeze.setIcon(new javax.swing.ImageIcon(getClass().getResource("/chat/realtime/Icon/minimize.png"))); // NOI18N
        ...
        btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/chat/realtime/Icon/close.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Border, javax.swing.GroupLayout.DEFAULT_SIZE, 727, Short.MAX_VALUE)
        );
    ...
    private chat.realtime.Form.Home home;
    private chat.realtime.Form.Loading loading;
    private chat.realtime.Form.Login login;
    private chat.realtime.Form.ViewImage viewImage;
