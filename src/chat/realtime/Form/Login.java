...
import chat.realtime.Component.Event.EventLogin;
import chat.realtime.Component.Event.EventMessage;
import chat.realtime.Component.Event.PublicEvent;
import chat.realtime.Main.Model.Model_Login;
import chat.realtime.Main.Model.Model_Message;
import chat.realtime.Main.Model.Model_Register;
...
public class Login extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        slide = new chat.realtime.Swing.PanelSlide();

        setBackground(new java.awt.Color(255, 255, 255));

        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("/chat/realtime/Icon/login_image.png"))); // NOI18N
    ...
    private chat.realtime.Swing.PanelSlide slide;
